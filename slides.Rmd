...
<div class="md-screen">
<iframe width="100%" src="http://localhost:3511" allowfullscreen="" frameborder="0" scrolling="no" height="470px"></iframe>
</div>
...
<div class="md-top-speaker"></div>
<div class="md-screen">
<iframe width="100%" src="http://localhost:3512" allowfullscreen="" frameborder="0" scrolling="no" height="470px"></iframe>
</div>
<button class="md-home-button"></button>
</div>
</div>
...
<div class="md-top-speaker"></div>
<div class="md-screen">
<iframe width="100%" src="http://localhost:3513" allowfullscreen="" frameborder="0" scrolling="no" height="470px"></iframe>
</div>
<button class="md-home-button"></button>
</div>
</div>
...
<div class="md-top-speaker"></div>
<div class="md-screen">
<iframe width="100%" src="http://localhost:3514" allowfullscreen="" frameborder="0" scrolling="no" height="470px"></iframe>
</div>
<button class="md-home-button"></button>
</div>
</div>
...
<div class="md-top-speaker"></div>
<div class="md-screen">
<iframe width="100%" src="http://localhost:3515" allowfullscreen="" frameborder="0" scrolling="no" height="470px"></iframe>
</div>
<button class="md-home-button"></button>
</div>
</div>
...
<div class="md-top-speaker"></div>
<div class="md-screen">
<iframe width="100%" src="http://localhost:3516" allowfullscreen="" frameborder="0" scrolling="no" height="470px"></iframe>
</div>
<button class="md-home-button"></button>
</div>
</div>
...
.center[
<img src="assets/images/golem.svg" width="10%" style="display: block; margin: auto;" class="svg-img"/>
]
...
--
.xsmall.pull-right[
- Run `run_app()` and note the provided `<APP_URL>`.
...
<div class="countdown" id="timer_60cd0f93" style="right:33%;bottom:0;" data-warnwhen="0">
<code class="countdown-time remark-inline-code"><span class="countdown-digits minutes">02</span><span class="countdown-digits colon">:</span><span class="countdown-digits seconds">00</span></code>
</div>
...
.small.pull-right[
## Your turn `r emo::ji("experiment")`
- Inspect the __app_ui.R__ code and find the corresponding pieces.
...
.xsmall.pull-right[
## Your turn `r emo::ji("experiment")`
- In __app_ui.R__, modify the navbar title.
- Add a subtitle.
...
.xsmall.pull-right[
## Your turn `r emo::ji("experiment")`
- In __app_ui.R__, add a new `f7ExpandableCard()` in the previously added `f7Tab()`.
- Give it an __id__.
- Below the card add a `f7Button("openCard", "Click me!")`.
- In __app_server.R__ add this code, replacing `<CARD_ID>`:
...
Time consuming, need __automated__ approach... The below scripts:
...
Create the PWA assets in your current shinyMobile project.

## Your turn `r emo::ji("experiment")`
- Run `charpente::set_pwa` inside your project.
- Check the `www` folder content.
- Run `devtools::load_all()` and `run_app()`.
...
- Deploy your app to `shinyapps.io` or browse to `https://dgranjon.shinyapps.io/shinyMobileGolemTest`.
