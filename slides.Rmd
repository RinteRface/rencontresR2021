...
---
class: header_background
# Road to PWA: Check your app (1/2)
...
---
class: header_background
# Road to PWA: Check your app (2/2)
...
If the app is not already installed, you should be prompted to install it (.xsmall[Installed apps can be accessed under `chrome://apps/`]).

.pull-left[
## Desktop
<video width="80%">
<source src="assets/movies/pwa-install-desktop.mov" type="video/mp4">
</video>
]
...
## iOS
<video width="80%">
<source src="assets/movies/pwa-install-ios.mov" type="video/mp4">
</video>
]
