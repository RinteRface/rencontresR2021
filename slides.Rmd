...
---
class: header_background
# Road to PWA 2: add PWA files

<br/>

Time consuming, need automated approach...

--
.small[
.pull-left[
We leverage the `{charpente}` package within our app folder:
...
---
class: header_background
# Road to PWA 3: Handle the installation